...
/*   Updated: 2025/08/27 22:16:57 by lseabra-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param base: The string representing the valid characters of the base (e.g., 
 * "0123456789ABCDEF").
 *
 ...
 * whitespace and sign characters. Return: 0 if the base is invalid or the 
